...
# .gitattributes (export-ignore). No Composer/npm step: this plugin is
# intentionally dependency-free, so `git archive` alone is a complete,
# self-contained build.
#
# Usage: bin/build-release-zip.sh
# Output: dist/oyster-wc-interakt-<version>.zip
